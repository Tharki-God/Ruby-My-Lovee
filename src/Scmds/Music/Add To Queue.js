...
module.exports = {
    ...
    level: "Music",
    type: "MESSAGE",
    description: "Search the seleted message text and add its result to queue.",
    exec: async (ctx) => {
        ...
        const arg = getUrls(msg.content) ? Array.from(getUrls(msg.content))[0] : args.join(" ");
        const query = arg || getAttachmentURL(msg);
        try {
